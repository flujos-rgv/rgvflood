    ...
    "sources": {
      "composite": {
        ...
        "data": {
          ...
          "minzoom": 0,
          "name":
            "Mapbox Bathymetry v2 + Mapbox Terrain v2 + Mapbox Streets v8",
          "scheme": "xyz",
          "tilejson": "3.0.0",
          "tiles": [
            `https://a.tiles.mapbox.com/v4/mapbox.mapbox-streets-v8,mapbox.mapbox-terrain-v2,mapbox.mapbox-bathymetry-v2/{z}/{x}/{y}.vector.pbf?access_token=${process.env.NEXT_PUBLIC_MAPBOX_TOKEN}`,
            `https://b.tiles.mapbox.com/v4/mapbox.mapbox-streets-v8,mapbox.mapbox-terrain-v2,mapbox.mapbox-bathymetry-v2/{z}/{x}/{y}.vector.pbf?access_token=${process.env.NEXT_PUBLIC_MAPBOX_TOKEN}`,
          ],
          "vector_layers": [
            {
              "id": "landuse",
